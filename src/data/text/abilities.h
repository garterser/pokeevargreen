...
static const u8 sLightningRodDescription[] = _("Grounds electric moves.");
...
static const u8 sRainDishDescription[] = _("Rain heals. Water faulters.");
...
static const u8 sRunAwayDescription[] = _("Boosts Normal, Runs easy.");
...
static const u8 sPickupDescription[] = _("Heals every turn.");
...
static const u8 sPlusDescription[] = _("Powers up Electric.");
static const u8 sMinusDescription[] = _("Powers up Steel.");
static const u8 sForecastDescription[] = _("Channels FIRE, ICE and WATER.");
